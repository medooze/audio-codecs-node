...
#define SWIGTYPE_p_AudioDecoderFacadeShared swig_types[2]
#define SWIGTYPE_p_AudioEncoderFacade swig_types[3]
#define SWIGTYPE_p_AudioInput swig_types[4]
#define SWIGTYPE_p_AudioOutput swig_types[5]
#define SWIGTYPE_p_AudioPipe swig_types[6]
#define SWIGTYPE_p_DWORD swig_types[7]
#define SWIGTYPE_p_EventLoop swig_types[8]
#define SWIGTYPE_p_FrameDispatchCoordinator swig_types[9]
#define SWIGTYPE_p_FrameDispatchCoordinatorShared swig_types[10]
#define SWIGTYPE_p_MediaFrameListener swig_types[11]
#define SWIGTYPE_p_MediaFrameListenerBridge swig_types[12]
#define SWIGTYPE_p_MediaFrameListenerBridgeShared swig_types[13]
...
#define SWIGTYPE_p_QWORD swig_types[18]
#define SWIGTYPE_p_RTPIncomingMediaStream swig_types[19]
#define SWIGTYPE_p_RTPIncomingMediaStreamShared swig_types[20]
#define SWIGTYPE_p_RTPReceiver swig_types[21]
#define SWIGTYPE_p_RTPReceiverShared swig_types[22]
#define SWIGTYPE_p_TimeService swig_types[23]
...
SWIGINTERN void Properties_SetFloatProperty(Properties *self,char const *key,float floatval){ self->SetProperty(key,floatval);	}
...
using AudioDecoderFacadeShared = std::shared_ptr<AudioDecoderFacade>;

static AudioDecoderFacadeShared AudioDecoderFacadeShared_null_ptr = {};

AudioDecoderFacadeShared* AudioDecoderFacadeShared_from_proxy(const v8::Local<v8::Value> input)
{
  void *ptr = nullptr;
  if (input.IsEmpty() || !input->IsObject()) return &AudioDecoderFacadeShared_null_ptr;
  v8::Local<v8::Proxy> proxy = v8::Local<v8::Proxy>::Cast(input);
  if (proxy.IsEmpty()) return &AudioDecoderFacadeShared_null_ptr;
  v8::Local<v8::Value> target = proxy->GetTarget();
  SWIG_ConvertPtr(target, &ptr, SWIGTYPE_p_AudioDecoderFacadeShared,  0 );
  if (!ptr) return &AudioDecoderFacadeShared_null_ptr;
  return reinterpret_cast<AudioDecoderFacadeShared*>(ptr);
}


SWIGINTERN AudioDecoderFacadeShared *new_AudioDecoderFacadeShared(){
		return new std::shared_ptr<AudioDecoderFacade>(new AudioDecoderFacade());
	}
SWIGINTERN MediaFrameListenerShared AudioDecoderFacadeShared_toMediaFrameListener(AudioDecoderFacadeShared *self){
	return std::static_pointer_cast<MediaFrameListener>(*self);
}
...
SWIGV8_ClientData _exports_AudioDecoderFacadeShared_clientData;
...
static SwigV8ReturnValue _wrap_RTPIncomingMediaStream_GetMediaSSRC(const SwigV8Arguments &args) {
  ...
  jsresult = SWIG_NewPointerObj((new DWORD(result)), SWIGTYPE_p_DWORD, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_FrameDispatchCoordinator_SetMaxDelayMs(const SwigV8Arguments &args) {
  ...
  FrameDispatchCoordinator_SetMaxDelayMs(arg1,SWIG_STD_MOVE(arg2));
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_MediaFrameListenerBridge_numFrames_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  ...
  jsresult = SWIG_NewPointerObj((new QWORD(result)), SWIGTYPE_p_QWORD, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_MediaFrameListenerBridge_width_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  ...
  arg1 = reinterpret_cast< MediaFrameListenerBridge * >(argp1);
  result =  ((arg1)->width);
  jsresult = SWIG_NewPointerObj((new WORD(result)), SWIGTYPE_p_WORD, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_MediaFrameListenerBridge_SetMaxDelayMs(const SwigV8Arguments &args) {
  ...
  arg1 = reinterpret_cast< MediaFrameListenerBridge * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_uint32_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MediaFrameListenerBridge_SetMaxDelayMs" "', argument " "2"" of type '" "uint32_t""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MediaFrameListenerBridge_SetMaxDelayMs" "', argument " "2"" of type '" "uint32_t""'");
    } else {
      arg2 = *(reinterpret_cast< uint32_t * >(argp2));
    }
  }
  MediaFrameListenerBridge_SetMaxDelayMs(arg1,SWIG_STD_MOVE(arg2));
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_Properties_SetFloatProperty(const SwigV8Arguments &args) {
  ...
  arg3 = static_cast< float >(val3);
  Properties_SetFloatProperty(arg1,(char const *)arg2,arg3);
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_new_AudioDecoderFacadeShared(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  AudioDecoderFacadeShared *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_AudioDecoderFacadeShared.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_AudioDecoderFacadeShared.");
  result = (AudioDecoderFacadeShared *)new_AudioDecoderFacadeShared();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_AudioDecoderFacadeShared, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_AudioDecoderFacadeShared_toMediaFrameListener(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  AudioDecoderFacadeShared *arg1 = (AudioDecoderFacadeShared *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  MediaFrameListenerShared result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_AudioDecoderFacadeShared_toMediaFrameListener.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_AudioDecoderFacadeShared, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AudioDecoderFacadeShared_toMediaFrameListener" "', argument " "1"" of type '" "AudioDecoderFacadeShared *""'"); 
  }
  arg1 = reinterpret_cast< AudioDecoderFacadeShared * >(argp1);
  result = AudioDecoderFacadeShared_toMediaFrameListener(arg1);
  jsresult = SWIG_NewPointerObj((new MediaFrameListenerShared(result)), SWIGTYPE_p_MediaFrameListenerShared, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_AudioDecoderFacadeShared_get(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  void *argp1 = 0 ;
  int res1 = 0 ;
  AudioDecoderFacade *result = 0 ;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_AudioDecoderFacadeShared_get.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_AudioDecoderFacadeShared, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AudioDecoderFacadeShared_get" "', argument " "1"" of type '" "AudioDecoderFacadeShared *""'"); 
  }
  arg1 = reinterpret_cast< AudioDecoderFacadeShared * >(argp1);
  result = (AudioDecoderFacade *)(arg1)->get();
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_AudioDecoderFacade, 0 |  0 );
...
static void _wrap_delete_AudioDecoderFacadeShared(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    AudioDecoderFacadeShared * arg1 = (AudioDecoderFacadeShared *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_AudioDecoderFacade = {"_p_AudioDecoderFacade", "AudioDecoderFacade *|p_AudioDecoderFacade", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_AudioDecoderFacadeShared = {"_p_AudioDecoderFacadeShared", "AudioDecoderFacadeShared *|p_AudioDecoderFacadeShared", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_AudioEncoderFacade = {"_p_AudioEncoderFacade", "AudioEncoderFacade *|p_AudioEncoderFacade", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_AudioInput = {"_p_AudioInput", "p_AudioInput|AudioInput *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_AudioDecoderFacadeShared,
...
static swig_cast_info _swigc__p_AudioDecoderFacadeShared[] = {  {&_swigt__p_AudioDecoderFacadeShared, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_AudioEncoderFacade[] = {  {&_swigt__p_AudioEncoderFacade, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_AudioInput[] = {  {&_swigt__p_AudioInput, 0, 0, 0},  {&_swigt__p_AudioPipe, _p_AudioPipeTo_p_AudioInput, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_AudioOutput[] = {  {&_swigt__p_AudioOutput, 0, 0, 0},  {&_swigt__p_AudioPipe, _p_AudioPipeTo_p_AudioOutput, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_AudioDecoderFacadeShared,
...
/* Name: _exports_AudioDecoderFacadeShared, Type: p_AudioDecoderFacadeShared, Dtor: _wrap_delete_AudioDecoderFacadeShared */
SWIGV8_FUNCTION_TEMPLATE _exports_AudioDecoderFacadeShared_class = SWIGV8_CreateClassTemplate("_exports_AudioDecoderFacadeShared");
SWIGV8_SET_CLASS_TEMPL(_exports_AudioDecoderFacadeShared_clientData.class_templ, _exports_AudioDecoderFacadeShared_class);
_exports_AudioDecoderFacadeShared_clientData.dtor = _wrap_delete_AudioDecoderFacadeShared;
if (SWIGTYPE_p_AudioDecoderFacadeShared->clientdata == 0) {
  SWIGTYPE_p_AudioDecoderFacadeShared->clientdata = &_exports_AudioDecoderFacadeShared_clientData;
}
...
SWIGV8_AddMemberFunction(_exports_AudioDecoderFacadeShared_class, "toMediaFrameListener", _wrap_AudioDecoderFacadeShared_toMediaFrameListener);
SWIGV8_AddMemberFunction(_exports_AudioDecoderFacadeShared_class, "get", _wrap_AudioDecoderFacadeShared_get);
...
#endif
/* Class: AudioDecoderFacadeShared (_exports_AudioDecoderFacadeShared) */
SWIGV8_FUNCTION_TEMPLATE _exports_AudioDecoderFacadeShared_class_0 = SWIGV8_CreateClassTemplate("AudioDecoderFacadeShared");
_exports_AudioDecoderFacadeShared_class_0->SetCallHandler(_wrap_new_AudioDecoderFacadeShared);
_exports_AudioDecoderFacadeShared_class_0->Inherit(_exports_AudioDecoderFacadeShared_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_AudioDecoderFacadeShared_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_AudioDecoderFacadeShared_obj = _exports_AudioDecoderFacadeShared_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_AudioDecoderFacadeShared_obj = _exports_AudioDecoderFacadeShared_class_0->GetFunction(context).ToLocalChecked();
#endif
...
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("AudioDecoderFacadeShared"), _exports_AudioDecoderFacadeShared_obj));
