...
SWIGINTERN MediaFrameListenerShared AudioDecoderFacadeShared_toMediaFrameListener__SWIG(AudioDecoderFacadeShared *self){
	return std::static_pointer_cast<MediaFrameListener>(*self);
}
...
static SwigV8ReturnValue _wrap_AudioDecoderFacadeShared_toMediaFrameListener(const SwigV8Arguments &args) {
  ...
  result = AudioDecoderFacadeShared_toMediaFrameListener__SWIG(arg1);
  jsresult = SWIG_NewPointerObj((new MediaFrameListenerShared(static_cast< const MediaFrameListenerShared& >(result))), SWIGTYPE_p_MediaFrameListenerShared, SWIG_POINTER_OWN |  0 );
...
static swig_type_info _swigt__p_AudioDecoderFacadeShared = {"_p_AudioDecoderFacadeShared", "p_AudioDecoderFacadeShared|AudioDecoderFacadeShared *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_MediaFrameListener[] = {  {&_swigt__p_MediaFrameListener, 0, 0, 0},  {&_swigt__p_MediaFrameListenerBridge, _p_MediaFrameListenerBridgeTo_p_MediaFrameListener, 0, 0},  {&_swigt__p_AudioDecoderFacade, _p_AudioDecoderFacadeTo_p_MediaFrameListener, 0, 0},{0, 0, 0, 0}};
